...
const Products = () => {
  ...
  const {data: products, isError, isLoading} = useGetProductsQuery(search);
          ...
          products?.map((product) => (
            ...
            >
              <div className="flex flex-col items-center">
                <Image
                    src={`https://s3-inventorymanagement-ketanvishe.s3.ap-south-1.amazonaws.com/product${Math.floor(Math.random() * 3) + 1}.png`}
                    alt={product.name}
                    width={150}
                    height={150}
